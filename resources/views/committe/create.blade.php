  ...
  <form method="POST" action="{{url('committe')}}">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" name="committe_name"/>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Committee Chairman</label>
                                 <input type="text" class="form-control" name="committe_chairman"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="committe_members"/>
                            </div>
                        </div>
                    </div>
                    <br>
