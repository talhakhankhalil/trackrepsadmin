...
class billsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $title = $request->input('Title');
         ...
         $this->bucket->insert("bills::".$id , ['Status'=>$status,'Mover' => $mover ,'DateIntroduced' => $date_introduced, 'Id' =>  $id, 'Title' =>  $title]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $title = $request->input('Title');
         ...
         $this->bucket->replace("bills::".$id , ['Status'=>$status,'Mover' => $mover ,'DateIntroduced' => $date_introduced, 'Id' =>  $id, 'Title' =>  $title]);
